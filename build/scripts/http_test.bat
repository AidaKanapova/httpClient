...
@rem ##########################################################################
@rem
@rem  http_test startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\http_test-1.0-SNAPSHOT.jar;%APP_HOME%\lib\json-20211205.jar


@rem Execute http_test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HTTP_TEST_OPTS%  -classpath "%CLASSPATH%" Main %*
